            ...
            <div className="col-span-1 lg:col-span-6 space-y-5 flex flex-col justify-between">
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-slate-100">
                <a
                  ...
                  className="flex items-center gap-1.5 px-5 py-2 rounded-lg bg-sky-600 hover:bg-sky-500 text-white font-bold text-xs transition shadow-md shadow-sky-600/20 active:scale-95"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-xs transition active:scale-95"
                >
                  <svg
