      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
        ...
        <div className="md:col-span-7 flex flex-col items-center md:items-start text-center md:text-left space-y-4">
          ...
          <div className="md:hidden pt-2 pb-1 flex justify-center">
            ...
            >
              <div className={`absolute -inset-2 bg-gradient-to-r from-sky-400 to-cyan-400 rounded-full blur-lg transition duration-500 ${isColored ? 'opacity-70 scale-105' : 'opacity-40'}`}></div>
              <div className="relative w-48 h-48 sm:w-52 sm:h-52 rounded-full overflow-hidden border-2 border-sky-400 bg-white shadow-xl active:scale-95 transition duration-200">
                <img 
