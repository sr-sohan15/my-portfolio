            ...
            <div className="col-span-1 lg:col-span-6 space-y-5 flex flex-col justify-between">
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-slate-800/80">
                <a
                  ...
                  className="flex items-center gap-1.5 px-5 py-2 rounded-lg bg-sky-500 hover:bg-sky-400 text-slate-950 font-bold text-xs transition shadow-md shadow-sky-500/20 active:scale-95"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 font-semibold text-xs transition active:scale-95"
                >
                  <svg
