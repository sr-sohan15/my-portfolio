...
import { Sparkles, Code2, Award, Briefcase, ExternalLink } from 'lucide-react';
...
const Hero = () => {
  ...
  const quickStats = [
    { label: "Research Paper", value: "1x IEEE", icon: Award, color: "text-amber-400" },
    { label: "Specialization", value: "MERN & Next.js", icon: Code2, color: "text-cyan-400" },
    { label: "Availability", value: "Immediate", icon: Briefcase, color: "text-emerald-400" },
  ];
  ...
  return (
    <section id="about" className="pt-20 sm:pt-24 md:pt-28 lg:pt-32 pb-4 md:pb-6 px-6 max-w-6xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
        ...
        <div className="md:col-span-7 flex flex-col items-center md:items-start text-center md:text-left space-y-5">
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <a 
              ...
              className="px-4 py-2.5 rounded-lg bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-200 font-semibold text-xs transition flex items-center gap-1.5"
            >
        ...
        {/* Desktop Image with 3D Tilt & Lighting */}
        <div className="hidden md:flex md:col-span-5 justify-center md:justify-end">
          <div 
            ...
            className="relative group cursor-pointer"
          >
            <div className="absolute -inset-2 bg-gradient-to-r from-cyan-500 to-sky-500 rounded-3xl blur-2xl opacity-30 group-hover:opacity-60 transition duration-500"></div>
            <div className="relative w-64 h-80 lg:w-72 lg:h-[360px] rounded-2xl overflow-hidden border border-slate-800 shadow-2xl bg-slate-900">
              <img 
                src={`${import.meta.env.BASE_URL}sohan.jpeg`} 
                alt="Md. Saidur Rahman Sohan" 
